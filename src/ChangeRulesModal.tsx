...
export const ChangeRulesModal = ({ showModal, setShowModal, setRules }) => {
    ...
    return (
        <div
            ...
            className={`absolute top-0 left-0 w-full h-full z-10 flex justify-center items-center ${!showModal ? 'hidden' : ''}`}
        >
            <div
                style={{ backgroundColor: 'rgba(255, 255, 255, 1)' }}
                className={'fixed top-0 bottom-0 right-0 left-0 m-auto w-max h-max px-4 py-2 rounded-md space-y-4'}
            >
                    ...
                    >
                        <div className={'w-full text-left flex items-center space-x-3'}>
                            ...
                            <input
                                ...
                                type="text"
                                value={updateRules.neighborsRangeStayAlive}
                                onChange={handleUpdateStayAlive}
                            />
